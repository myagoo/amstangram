...
export var Directions: Point[][][] = [];

export var InsideDirections: Point[][][] = [];

export var SegmentDirections: Point[][][][] = [];

export var numOrientations = 8;
...
export var FlipDirections = [[new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(-6, 0)), /* 0 */
