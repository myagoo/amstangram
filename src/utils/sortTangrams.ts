...
export const sortTangrams = (
  tangramA: import("../types").SavedTangram,
  tangramB: import("../types").SavedTangram
) => {
...
export const sortDigitsTangrams = (
  tangramA: import("../types").SavedTangram,
  tangramB: import("../types").SavedTangram
) => {
...
export const sortLettersTangrams = (
  tangramA: import("../types").SavedTangram,
  tangramB: import("../types").SavedTangram
) => {
