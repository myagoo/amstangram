...
Directions[0][0] =
    [new Point(new IntAdjoinSqrt2(0, 12 * FACTOR), new IntAdjoinSqrt2(0, 0)),
        new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(0, 12 * FACTOR))];
Directions[1][0] =
    [new Point(new IntAdjoinSqrt2(12 * FACTOR, 0), new IntAdjoinSqrt2(0, 0)),
        new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(12 * FACTOR, 0))];
Directions[2][0] =
    [new Point(new IntAdjoinSqrt2(0, 6 * FACTOR), new IntAdjoinSqrt2(0, 0)),
        new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(0, 6 * FACTOR))];
Directions[3][0] =
    [new Point(new IntAdjoinSqrt2(0, 6 * FACTOR), new IntAdjoinSqrt2(0, 0)),
        new Point(new IntAdjoinSqrt2(0, 6 * FACTOR), new IntAdjoinSqrt2(0, 6 * FACTOR)),
        new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(0, 6 * FACTOR))];
Directions[4][0] =
    [new Point(new IntAdjoinSqrt2(12 * FACTOR, 0), new IntAdjoinSqrt2(0, 0)),
        new Point(new IntAdjoinSqrt2(18 * FACTOR, 0), new IntAdjoinSqrt2(6 * FACTOR, 0)),
        new Point(new IntAdjoinSqrt2(6 * FACTOR, 0), new IntAdjoinSqrt2(6 * FACTOR, 0))];
Directions[5][0] =
    [new Point(new IntAdjoinSqrt2(12 * FACTOR, 0), new IntAdjoinSqrt2(0, 0)),
        new Point(new IntAdjoinSqrt2(18 * FACTOR, 0), new IntAdjoinSqrt2(-6 * FACTOR, 0)),
        new Point(new IntAdjoinSqrt2(6 * FACTOR, 0), new IntAdjoinSqrt2(-6 * FACTOR, 0))];
...
var FlipDirections = [[new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(-6 * FACTOR, 0)), /* 0 */
    new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(0, 6 * FACTOR)), /* 1 */
    new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(18 * FACTOR, 0)), /* 2 */
    new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(0, 12 * FACTOR)), /* 3 */
    new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(6 * FACTOR, 0)), /* 4 */
    new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(0, -6 * FACTOR)), /* 5 */
    new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(-18 * FACTOR, 0)), /* 6 * FACTOR */
    new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(0, -12 * FACTOR))], /* 7 */
    [new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(6 * FACTOR, 0)), /* 0 */
        new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(0, 12 * FACTOR)), /* 1 */
        new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(18 * FACTOR, 0)), /* 2 */
        new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(0, 6 * FACTOR)), /* 3 */
        new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(-6 * FACTOR, 0)), /* 4 */
        new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(0, -12 * FACTOR)), /* 5 */
        new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(-18 * FACTOR, 0)), /* 6 * FACTOR */
        new Point(new IntAdjoinSqrt2(0, 0), new IntAdjoinSqrt2(0, -6 * FACTOR))]];
/* 7 */